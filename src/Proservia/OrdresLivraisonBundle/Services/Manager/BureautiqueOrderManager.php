...
/**
 * Class BureautiqueOrderManager
 * @package Proservia\OrdresLivraisonBundle\Services\Manager
 */
class BureautiqueOrderManager extends AbstractManager
{
    /**
     * @var SiteManager
     */
    ...
    public function createArray($itemLoad)
    {
        ...
        $itemArray['portableUL1']    = $itemToTransform->getPortableUL1();
        $itemArray['portableUL2']    = $itemToTransform->getPortableUL2();
